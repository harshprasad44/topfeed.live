...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Topnieuwsfeed Live - Haal het laatste nieuws uit de hele wereld op vanuit Nederland"
        ...
        openGraph={{
          ...
          title:
            "Topnieuwsfeed Live - Haal het laatste nieuws uit de hele wereld op vanuit Nederland",
          description:
            "Met dit portaal kunt u het beste Nederland en wereldwijde nieuws online krijgen, samen met titels en afbeeldingen. U kunt ook per land in verschillende talen zoeken naar nieuws, waardoor u betere zoekresultaten krijgt dan andere portals.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Netherlands Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/nl/${pageNumber - 1}`);
              }
            }}
