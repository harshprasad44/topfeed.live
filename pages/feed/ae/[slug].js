...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - احصل على آخر الأخبار في جميع أنحاء العالم من الإمارات العربية المتحدة"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - احصل على آخر الأخبار في جميع أنحاء العالم من الإمارات العربية المتحدة",
          description:
            "تتيح لك هذه البوابة الحصول على أفضل أخبار الإمارات العربية المتحدة والعالم عبر الإنترنت إلى جانب العناوين والصور ، كما يمكنك البحث عن بلد الأخبار بلغات مختلفة ، مما يوفر نتائج بحث أفضل من البوابات الأخرى.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>United Arab Emirates Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/ae/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=ae&pageSize=5&page=${pageNumber}`,
    {
      headers: {
