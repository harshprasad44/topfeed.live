...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - Obtenha as últimas notícias do Brasil em todo o mundo"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - Obtenha as últimas notícias do Brasil em todo o mundo",
          description:
            "Este portal permite que você obtenha as principais notícias do Brasil e do mundo online junto com títulos e imagens, você também pode pesquisar notícias por país em diferentes idiomas, fornecendo resultados de pesquisa melhores do que outros portais.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Brazil Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/br/${pageNumber - 1}`);
              }
            }}
