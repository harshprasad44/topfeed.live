...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Labāko ziņu plūsma tiešraidē - no Latvijas iegūstiet jaunākās ziņas visā pasaulē"
        ...
        openGraph={{
          ...
          title:
            "Labāko ziņu plūsma tiešraidē - no Latvijas iegūstiet jaunākās ziņas visā pasaulē",
          description:
            "Šis portāls ļauj tiešsaistē iegūt aktuālākās Latvijas un pasaules ziņas, kā arī nosaukumus un attēlus, kā arī meklēt ziņas dažādās valstīs dažādās valodās, nodrošinot labākus meklēšanas rezultātus nekā citos portālos.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Latvia Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/lv/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=lv&pageSize=5&page=${pageNumber}`,
    {
      headers: {
