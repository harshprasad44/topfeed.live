...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Legfrissebb hírcsatorna - Hozza le a legfrissebb híreket a világ minden tájáról Magyarországról"
        ...
        openGraph={{
          ...
          title:
            "Legfrissebb hírcsatorna - Hozza le a legfrissebb híreket a világ minden tájáról Magyarországról",
          description:
            "Ez a portál lehetővé teszi, hogy online híreket és híreket szerezzen online, címekkel és képekkel együtt. Országonként is kereshet híreket különböző nyelveken, jobb keresési eredményeket kínálva, mint más portálok.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Hungary Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/hu/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=hu&pageSize=5&page=${pageNumber}`,
    {
      headers: {
