...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Populiariausias naujienų srautas tiesiogiai - gaukite naujausias naujienas visame pasaulyje iš Lietuvos"
        ...
        openGraph={{
          ...
          title:
            "Populiariausias naujienų srautas tiesiogiai - gaukite naujausias naujienas visame pasaulyje iš Lietuvos",
          description:
            "Šis portalas leidžia jums gauti geriausių Lietuvos ir pasaulio naujienų internete kartu su pavadinimais ir vaizdais, taip pat galite ieškoti naujienų pagal šalis įvairiomis kalbomis, pateikdami geresnius paieškos rezultatus nei kiti portalai.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Lithuania Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/lt/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=lt&pageSize=5&page=${pageNumber}`,
    {
      headers: {
