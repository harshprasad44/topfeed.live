...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - Načtěte nejnovější zprávy z celého světa z České republiky"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - Načtěte nejnovější zprávy z celého světa z České republiky",
          description:
            "Tento portál vám umožňuje získat nejlepší české a světové zprávy online spolu s tituly a obrázky. Můžete také vyhledávat zprávy v různých jazycích v různých jazycích a poskytovat tak lepší výsledky vyhledávání než jiné portály.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Czech Republic Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/cz/${pageNumber - 1}`);
              }
            }}
