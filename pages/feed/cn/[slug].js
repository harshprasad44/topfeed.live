    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          title: "实时新闻速递-从中国获取全球最新新闻",
          description:
            "通过该门户网站，您可以在线获取中国和世界各地的热门新闻以及标题和图像，还可以使用其他语言在各个国家/地区搜索新闻，从而提供比其他门户网站更好的搜索结果。",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>China Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/cn/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=cn&pageSize=5&page=${pageNumber}`,
    {
      headers: {
