...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - получайте последние новости со всего мира из России"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - получайте последние новости со всего мира из России",
          description:
            "Этот портал позволяет получать в режиме онлайн лучшие новости России и мира, а также заголовки и изображения. Вы также можете искать новости по странам на разных языках, обеспечивая лучшие результаты поиска, чем на других порталах.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Russia Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/ru/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=ru&pageSize=5&page=${pageNumber}`,
    {
      headers: {
