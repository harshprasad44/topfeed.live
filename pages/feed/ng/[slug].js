...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - Fetch latest news across the globe from Nigeria"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - Fetch latest news across the globe from Nigeria",
          description:
            "This portal allows you to get top Nigeria and worldwide news online along with titles and images, you can also search news country wise in different languages, providing better search results than other portals.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Nigeria Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/ng/${pageNumber - 1}`);
              }
            }}
