...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - Aduceți cele mai noi știri din întreaga lume din România"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - Aduceți cele mai noi știri din întreaga lume din România",
          description:
            "Acest portal vă permite să obțineți știri de top din România și din întreaga lume online împreună cu titluri și imagini, puteți căuta știri în țară în diferite limbi, oferind rezultate de căutare mai bune decât alte portaluri.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Romania Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/ro/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=ro&pageSize=5&page=${pageNumber}`,
    {
      headers: {
