...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="トップニュースフィードライブ-日本から世界中の最新ニュースを取得"
        ...
        openGraph={{
          ...
          title:
            "トップニュースフィードライブ-日本から世界中の最新ニュースを取得",
          description:
            "このポータルでは、タイトルや画像とともに、日本や世界のトップニュースをオンラインで入手できます。また、さまざまな言語で国ごとにニュースを検索できるため、他のポータルよりも優れた検索結果が得られます。",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Japan Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/jp/${pageNumber - 1}`);
              }
            }}
