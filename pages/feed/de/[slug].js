...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - Holen Sie sich weltweit die neuesten Nachrichten aus Deutschland"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - Holen Sie sich weltweit die neuesten Nachrichten aus Deutschland",
          description:
            "Über dieses Portal können Sie Top-Nachrichten aus Deutschland und der ganzen Welt online zusammen mit Titeln und Bildern abrufen. Sie können auch nach Nachrichten in verschiedenen Sprachen suchen und so bessere Suchergebnisse als in anderen Portalen erzielen.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Germany Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/de/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=de&pageSize=5&page=${pageNumber}`,
    {
      headers: {
