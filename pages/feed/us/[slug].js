...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - Fetch latest news across the globe from United States"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - Fetch latest news across the globe from United States",
          description:
            "This portal allows you to get top United States and worldwide news online along with titles and images, you can also search news country wise in different languages, providing better search results than other portals.",
          images: [
            {
        ...
        additionalLinkTags={[
          {
            rel: "canonical",
            hrefLang: "en-us",
            href: "https://topfeed.live/feed/us/1/",
          },
        ]}
        languageAlternates={[
          {
