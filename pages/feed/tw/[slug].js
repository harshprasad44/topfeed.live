    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          title: "实时新闻速递-从台湾获取全球最新新闻",
          description:
            "该门户网站使您可以在线获取台湾和全球最新新闻以及标题和图像，还可以使用其他语言在各个国家/地区搜索新闻，从而提供比其他门户网站更好的搜索结果。",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Taiwan Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/tw/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=tw&pageSize=5&page=${pageNumber}`,
    {
      headers: {
