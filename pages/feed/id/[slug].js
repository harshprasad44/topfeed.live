...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - Dapatkan berita terbaru dari seluruh dunia dari Indonesia"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - Dapatkan berita terbaru dari seluruh dunia dari Indonesia",
          description:
            "Portal ini memungkinkan Anda untuk mendapatkan berita top Indonesia dan dunia secara online bersama dengan judul dan gambar, Anda juga dapat mencari berita negara bijaksana dalam berbagai bahasa, memberikan hasil pencarian yang lebih baik daripada portal lain.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Indonesia Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/id/${pageNumber - 1}`);
              }
            }}
