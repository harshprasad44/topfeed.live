...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="En İyi Haber Akışı Canlı - Dünyadaki en son haberleri Türkiye'den alın"
        ...
        openGraph={{
          ...
          title:
            "En İyi Haber Akışı Canlı - Dünyadaki en son haberleri Türkiye'den alın",
          description:
            "Bu portal, başlıklar ve görsellerin yanı sıra Türkiye ve dünya çapındaki en iyi haberleri çevrimiçi olarak almanızı sağlar, ayrıca haberleri ülke bazında farklı dillerde arayabilir ve diğer portallardan daha iyi arama sonuçları sunabilirsiniz.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Turkey Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/tr/${pageNumber - 1}`);
              }
            }}
