...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live: Obtenga las últimas noticias de todo el mundo desde Colombia"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live: Obtenga las últimas noticias de todo el mundo desde Colombia",
          description:
            "Este portal le permite obtener las principales noticias de Colombia y el mundo en línea junto con títulos e imágenes, también puede buscar noticias por país en diferentes idiomas, proporcionando mejores resultados de búsqueda que otros portales.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Colombia Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/co/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=co&pageSize=5&page=${pageNumber}`,
    {
      headers: {
