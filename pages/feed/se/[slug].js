...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - Hämta senaste nyheter över hela världen från Sverige"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - Hämta senaste nyheter över hela världen från Sverige",
          description:
            "Med den här portalen kan du få de bästa nyheterna i Sverige och världen över på nätet tillsammans med titlar och bilder. Du kan också söka nyheter på landsnivå på olika språk, vilket ger bättre sökresultat än andra portaler.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Sweden Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/se/${pageNumber - 1}`);
              }
            }}
