...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Κορυφαία ροή ειδήσεων ζωντανά - Λήψη τελευταίων ειδήσεων σε όλο τον κόσμο από την Ελλάδα"
        ...
        openGraph={{
          ...
          title:
            "Κορυφαία ροή ειδήσεων ζωντανά - Λήψη τελευταίων ειδήσεων σε όλο τον κόσμο από την Ελλάδα",
          description:
            "Αυτή η πύλη σάς επιτρέπει να λαμβάνετε κορυφαίες ειδήσεις στην Ελλάδα και σε όλο τον κόσμο μαζί με τίτλους και εικόνες, μπορείτε επίσης να αναζητάτε ειδήσεις στη χώρα σε διαφορετικές γλώσσες, παρέχοντας καλύτερα αποτελέσματα αναζήτησης από άλλες πύλες.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Greece Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/gr/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=gr&pageSize=5&page=${pageNumber}`,
    {
      headers: {
