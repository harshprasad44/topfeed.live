...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Потік найкращих новин у прямому ефірі - Отримайте останні новини з усього світу з України"
        ...
        openGraph={{
          ...
          title:
            "Потік найкращих новин у прямому ефірі - Отримайте останні новини з усього світу з України",
          description:
            "Цей портал дозволяє отримувати найкращі новини про Україну та всесвітню мережу в Інтернеті разом із заголовками та зображеннями. Ви також можете здійснювати пошук країн новин на різних мовах, забезпечуючи кращі результати пошуку, ніж інші портали.",
          images: [
            {
