...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed na żywo - Pobierz najnowsze wiadomości z Polski z całego świata"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed na żywo - Pobierz najnowsze wiadomości z Polski z całego świata",
          description:
            "Portal ten umożliwia dostęp do najważniejszych wiadomości z Polski i ze świata w Internecie wraz z tytułami i obrazami, można również przeszukiwać wiadomości według krajów w różnych językach, zapewniając lepsze wyniki wyszukiwania niż inne portale.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Poland Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/pl/${pageNumber - 1}`);
              }
            }}
