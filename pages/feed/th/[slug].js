...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="ฟีดข่าวยอดนิยม - ดึงข้อมูลข่าวสารล่าสุดทั่วโลกจากประเทศไทย"
        ...
        openGraph={{
          ...
          title: "ฟีดข่าวยอดนิยม - ดึงข้อมูลข่าวสารล่าสุดทั่วโลกจากประเทศไทย",
          description:
            "พอร์ทัลนี้ช่วยให้คุณได้รับข่าวสารชั้นนำของประเทศไทยและทั่วโลกทางออนไลน์พร้อมกับชื่อเรื่องและรูปภาพคุณยังสามารถค้นหาประเทศข่าวสารที่ชาญฉลาดในภาษาต่างๆซึ่งให้ผลการค้นหาที่ดีกว่าพอร์ทัลอื่น ๆ",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Thailand Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/th/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=th&pageSize=5&page=${pageNumber}`,
    {
      headers: {
