...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live: Obtenga las últimas noticias de todo el mundo desde Mexico"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live: Obtenga las últimas noticias de todo el mundo desde Mexico",
          description:
            "Este portal le permite obtener las mejores noticias de Mexico y el mundo en línea junto con títulos e imágenes, también puede buscar noticias por país en diferentes idiomas, proporcionando mejores resultados de búsqueda que otros portales.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Mexico Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/mx/${pageNumber - 1}`);
              }
            }}
