...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="עדכון חדשות מוביל בשידור חי - הבא חדשות מישראל ברחבי העולם"
        ...
        openGraph={{
          ...
          title: "עדכון חדשות מוביל בשידור חי - הבא חדשות מישראל ברחבי העולם",
          description:
            "פורטל זה מאפשר לך לקבל חדשות מקוונות בישראל ובעולם כולו יחד עם כותרות ותמונות, אתה יכול גם לחפש חדשות מדינות בשפות שונות, ומספק תוצאות חיפוש טובות יותר מאשר פורטלים אחרים.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Israel Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/il/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=il&pageSize=5&page=${pageNumber}`,
    {
      headers: {
