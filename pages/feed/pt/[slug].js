...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - Obtenha as últimas notícias de Portugal em todo o mundo"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - Obtenha as últimas notícias de Portugal em todo o mundo",
          description:
            "Este portal permite-lhe obter online as principais notícias de Portugal e de todo o mundo, juntamente com títulos e imagens, podendo também pesquisar notícias por país em diferentes idiomas, proporcionando melhores resultados de pesquisa do que outros portais.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Portugal Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/pt/${pageNumber - 1}`);
              }
            }}
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=pt&pageSize=5&page=${pageNumber}`,
    {
      headers: {
