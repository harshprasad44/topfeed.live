...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live: Obtenga las últimas noticias de todo el mundo desde Argentina"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live: Obtenga las últimas noticias de todo el mundo desde Argentina",
          description:
            "Este portal le permite obtener las mejores noticias de Argentina y el mundo en línea junto con títulos e imágenes, también puede buscar noticias por país en diferentes idiomas, proporcionando mejores resultados de búsqueda que otros portales.",
          images: [
            {
      ...
      <div className="page-container">
        ...
        <h3 className={styles.countryFeed}>Argentina Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/ar/${pageNumber - 1}`);
              }
            }}
