...
const Feed = ({ pageNumber, articles }) => {
  ...
  return (
    <>
      <NextSeo
        title="Top News Feed Live - Изтеглете последните новини от цял ​​свят от България"
        ...
        openGraph={{
          ...
          title:
            "Top News Feed Live - Изтеглете последните новини от цял ​​свят от България",
          description:
            "Този портал ви позволява да получавате най-добрите новини за България и в световен мащаб онлайн, заедно със заглавия и изображения, можете също така да търсите новини по държави на различни езици, предоставяйки по-добри резултати от търсенето от други портали.",
          images: [
            {
      ...
      <div className="page-container">
        <Toolbar />
        <Country />
        <h3 className={styles.countryFeed}>Bulgaria Feed</h3>
        ...
        <div className={styles.paginator}>
          <div
            onClick={() => {
              if (pageNumber > 1) {
                router.push(`/feed/bg/${pageNumber - 1}`);
              }
            }}
